                    ...
                    <div class="d-md-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="input-group" style="max-width: 250px;">
                                ...
                                <input type="text" class="form-control" placeholder="April 1" value="April 1">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row detail-row">
                                ...
                                <div class="col-sm-8 detail-value">Hydraulic pump with pressure loss issues</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label for="assignTechnician" class="form-label">Assign to Technician</label>
                            <select class="form-select" id="assignTechnician">
                                <option value="">Select Technician</option>
                                <option value="1">Budi</option>
                                <option value="2">Rina</option>
