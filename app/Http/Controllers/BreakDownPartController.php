...
class BreakdownPartController extends Controller
{
    public function index()
    {
        ...
        return view('breakdown_parts.index', compact('breakdownParts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('breakdown.parts.index')->with('success', 'Breakdown Part Added Successfully');
    }
